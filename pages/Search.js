        ...
        <Wrapper>
            ...
            <InputContainer>
                ...
                <InputBoxes>
                    ...
                    <Input placeholder="Where to?" value={dropof} onChange={(e)=> setDropof(e.target.value)}/>
                </InputBoxes>
...
bg-black mt-2 mx-4 px-4 py-3 text-center text-2xl text-white cursor-pointer
`